...
/**
 * @author zapreevis
 * The panel for storing the news messages
 */
public class NewsMessagesPanel extends MessagesPanel {
	 ...
	 */
	public NewsMessagesPanel( final boolean addDecorations, final boolean showActionPanel,
