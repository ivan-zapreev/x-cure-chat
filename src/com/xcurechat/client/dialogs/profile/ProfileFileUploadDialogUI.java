...
/**
 * @author zapreevis
 * Attach files to the user profile
 */
public class ProfileFileUploadDialogUI extends FileUploadManagerDialog {
	...
	public ProfileFileUploadDialogUI(DialogBox parentDialog) {
	...
	protected String getDialogTitle() {
		return titlesI18N.profileFileUploadDialog();
	}

	@Override
	protected String getUploadFileServletURL() {
		return ServerSideAccessManager.getProfileFilesManagerURL();
	}
	
	@Override
	protected void onSuccessfulFileUpload( final ShortFileDescriptor fileDesc ) {
		if( parentDialog instanceof ProfileFilesManagerUI ) {
			( (ProfileFilesManagerUI) parentDialog ).addNewProfileFile( fileDesc );
		}
	}
