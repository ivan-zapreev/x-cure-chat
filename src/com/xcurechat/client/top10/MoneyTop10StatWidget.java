...
/**
 * @author zapreevis
 * This widget gets the money results for the top10 section
 */
public class MoneyTop10StatWidget extends PagedTop10BodyComponent<ShortUserData> {
	...
	private final static int DATA_TO_DISPLAY = UserAvatarWidget.DISPLAY_AVATAR_IMAGE_DATA |
											   UserAvatarWidget.DISPLAY_MONEY_DATA        |
											   UserAvatarWidget.DISPLAY_USER_NAME_DATA;

	/**
	 * The basic constructor 
	 */
	public MoneyTop10StatWidget() {
		super( titlesI18N.top10MoneyTitle(), titlesI18N.top10MoneyDesc() );
	...
	protected Top10SearchData.SearchTypes getStatisticsSearchType() {
		return Top10SearchData.SearchTypes.TOP_MONEY_SEARH_TYPE;
	}
