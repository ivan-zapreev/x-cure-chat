...
/**
 * @author zapreevis
 * This widget gets the froum-messages-count results for the top10 section
 */
public class ForumPostsTop10StatWidget extends PagedTop10BodyComponent<ShortUserData> {
	...
	private final static int DATA_TO_DISPLAY = UserAvatarWidget.DISPLAY_AVATAR_IMAGE_DATA |
											   UserAvatarWidget.DISPLAY_FORUM_POSTS_DATA  |
											   UserAvatarWidget.DISPLAY_USER_NAME_DATA;

	/**
	 * The basic constructor 
	 */
	public ForumPostsTop10StatWidget() {
		super( titlesI18N.top10ForumPostsTitle(), titlesI18N.top10ForumPostsDesc() );
	...
	protected Top10SearchData.SearchTypes getStatisticsSearchType() {
		return Top10SearchData.SearchTypes.TOP_FORUM_POSTS_SEARH_TYPE;
	}
