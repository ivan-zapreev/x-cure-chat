...
/**
 * @author zapreevis
 * This widget gets the user-visits results for the top10 section
 */
public class VisitsTop10StatWidget extends PagedTop10BodyComponent<ShortUserData> {
	...
	private final static int DATA_TO_DISPLAY = UserAvatarWidget.DISPLAY_AVATAR_IMAGE_DATA |
											   UserAvatarWidget.DISPLAY_USER_VISIT_DATA    |
											   UserAvatarWidget.DISPLAY_USER_NAME_DATA;

	/**
	 * The basic constructor 
	 */
	public VisitsTop10StatWidget() {
		super( titlesI18N.top10UserVisitsTitle(), titlesI18N.top10UserVisitsDesc() );
		//Use the user file's stat widget style because it has larger width
	...
	protected Top10SearchData.SearchTypes getStatisticsSearchType() {
		return Top10SearchData.SearchTypes.TOP_USER_VISITS_SEARCH_TYPE;
	}
	...
	/**
	 * We override the parent's method for this widget in order to facilitate showing users' visits right away
	 */
	@Override
