...
/**
 * @author zapreevis
 * This widget gets the chat-messages-count results for the top10 section
 */
public class ChatMsgsTop10StatWidget extends PagedTop10BodyComponent<ShortUserData> {
	...
	private final static int DATA_TO_DISPLAY = UserAvatarWidget.DISPLAY_AVATAR_IMAGE_DATA  |
											   UserAvatarWidget.DISPLAY_CHAT_MESSAGES_DATA |
											   UserAvatarWidget.DISPLAY_USER_NAME_DATA;
	
	/**
	 * The basic constructor 
	 */
	public ChatMsgsTop10StatWidget() {
		super( titlesI18N.top10ChatMsgsTitle(), titlesI18N.top10ChatMsgsDesc() );
	...
	protected Top10SearchData.SearchTypes getStatisticsSearchType() {
		return Top10SearchData.SearchTypes.TOP_CHAT_MESSAGES_SEARH_TYPE;
	}
